...
SYNONYM_MAP: dict [str, list[str]] ={
    "comichão": ["coceira", "prurido", "comichão", "vontade de me coçar", "a coçar", "comixão"],
    ...
    "agitação": ["agitação", "inquietação", "irrequieto", "agitado", "agitada", "não para quieto", "hiperativo", "desassossegado", "em pulgas"],
    ...
    "desidratação": ["desidratação", "falta de água", "boca muito seca", "secura", "sede extrema"],
    "indigestão": ["indigestão", "enfartamento", "mal estar no estômago", "empanzinado", "dispepsia", "estômago pesado", "a comida caiu mal", "comida parada"],
    ...
    "náuseas": ["náuseas", "enjoo", "enjoos", "vontade de vomitar", "enjoada", "enjoado", "estômago embrulhado", "engulhos"],
    ...
    "diarreia": ["caganeira", "fezes moles", "diarreia", "desarranjo", "intestino solto", "frouxeira"],
    ...
    "comichão interna": ["coceira por dentro", "comichão interna", "comichão no corpo todo", "prurido interno"],
