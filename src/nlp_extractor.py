...
SYNONYM_MAP: dict [str, list[str]] ={
    ...
    "fadiga": ["cansaço", "cansado", "fadigado","exaustão", "moleza", "sem energia", "esgotamento", "prostração", "astenia", "corpo pesado", "estafado", "derreado", "sem forças"],
    ...
    "pele amarelada": ["pele amarela", "amarelada", "olhos amarelos", "cor de açafrão", "amarelo", "olhos estão amarelos, pele muito amarelada, pele muito amarela"],
